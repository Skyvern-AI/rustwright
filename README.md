...
**A Rust rewrite of Playwright** for Python and Node.js. Change one import and your code runs on an in-process Rust CDP engine — **[70% less memory](BENCHMARK.md#client-memory-form-fill-diagnostic)** (no Node driver) and no Playwright automation fingerprint. Alpha; Chromium-only.
