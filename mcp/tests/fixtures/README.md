...
| `tools-list.json` | Complete canonical `mirror` catalog. | `d09e72fa33f2d1961dbcaf56f78ac636776ccb6849a09004897c4a196b778d70` | `RUSTWRIGHT_UPDATE_TOOL_CATALOG=1 cargo test --manifest-path mcp/Cargo.toml --locked catalog_matches_archived_bytes` |
